...
public class ProfileView extends BorderPane {
    ...
    public ProfileView() {
        ...
        btnBack.getStyleClass().add("nav-btn");
        ...
        infoCard.getStyleClass().add("profile-info-card"); 
    ...
    private HBox createGridRow(String labelText, String valueText) {
        ...
        lblLeft.setFont(Font.font("System", 14));
        lblLeft.getStyleClass().add("profile-label-left"); 
        lblLeft.setPrefWidth(140);

        Label lblRight = new Label(valueText);
        lblRight.setFont(Font.font("System", 14));
        lblRight.getStyleClass().add("profile-label-right"); 
